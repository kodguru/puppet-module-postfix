      ...
      validations = {
        ...
        'Optional[String[1]]' => {
          name:    ['main_compatibility_level', 'main_html_directory', 'main_debug_peer_level', 'main_mailbox_command', 'main_mail_owner',
                    ...
                    'main_recipient_delimiter', 'main_mydestination', 'main_myorigin'],
          valid:   ['valid'],
          invalid: [['array'], { 'ha' => 'sh' }],
        ...
        'String[1]' => {
          name:    ['main_alias_database', 'main_alias_maps', 'main_inet_protocols', 'main_transport_maps', 'main_virtual_alias_maps', 'service_name'],
          valid:   ['valid'],
